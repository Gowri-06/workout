...
driver.find_element(By.XPATH, "//a[@href='/credits']").click()
...
time.sleep(4)
card_expiry = driver.find_element(By.NAME, "cardExpiry").send_keys("07/27")
card_cvc = driver.find_element(By.NAME, "cardCvc").send_keys("022")
time.sleep(4)
billing_name = driver.find_element(By.NAME, "billingName").send_keys("Legend")
billing_country = driver.find_element(By.NAME, "billingCountry").send_keys("United States")
