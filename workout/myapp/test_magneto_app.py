...
magneto_app_select = driver.find_element(By.XPATH, "//a[@href='/frontend/magento-create-app/']")
magneto_app_select.click()
# Enter form details
driver.find_element(By.NAME, "app_name").send_keys("Test App magneto2")
driver.find_element(By.NAME, "project-name").send_keys("Test Project2")
...
# driver.back()
driver.find_element(By.NAME, "magento_public_key").send_keys("********public_key")
driver.find_element(By.NAME, "magento_private_key").send_keys("*******private_key")
driver.find_element(By.NAME, "magento_admin_username").send_keys("admin_name")
